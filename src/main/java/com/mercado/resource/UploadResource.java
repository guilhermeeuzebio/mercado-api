...
import com.mercado.repository.ImagemRepository;
...
public class UploadResource {
	...
	public ResponseEntity<String> handleFileUpload(@RequestParam("file") MultipartFile file, Imagem imagem) {
		String message = "";
		try {
			storageService.store(file);
			files.add(file.getOriginalFilename());
			message = "You successfully uploaded " + file.getOriginalFilename() + "!";
			imagem.setNomeImagem(url+file.getOriginalFilename());
